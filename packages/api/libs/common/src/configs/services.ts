import { NotificationsServiceClient, NotificationsServiceService } from '@proto/notifications';
...
function extractServiceMetadata<T extends Record<string, { path: string }>>(
  client: { serviceName: string }, service: T
) {
...
export const GrpcServices = Object.freeze({
  ...
  NOTIFICATIONS: extractServiceMetadata(NotificationsServiceClient, NotificationsServiceService),
});
